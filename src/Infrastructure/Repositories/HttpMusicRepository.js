        ...
        return tracksArray.map(rawTrack => {
            try {
                ...
                const trackData = {
                    ...
                    genre: rawTrack.type || rawTrack.genre,
                    type: rawTrack.type || rawTrack.genre,
                    year: rawTrack.year,
                    ...
                    tags: rawTrack.tags || [],
                    playlists: rawTrack.playlists || [],
                    notes: rawTrack.notes || '',
                    autoplay: rawTrack.autoplay !== undefined ? rawTrack.autoplay : true,
